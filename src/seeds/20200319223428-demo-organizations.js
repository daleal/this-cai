...
module.exports = {
  up: (queryInterface) => queryInterface.bulkInsert('organizations', [{
    ...
    img: 'https://res.cloudinary.com/hrvt6ouf6/image/upload/v1591226036/seeds/preu_yrljym.jpg',
    created_at: new Date(),
    updated_at: new Date(),
  }, {
    ...
    created_at: new Date(),
    updated_at: new Date(),
    img: 'https://res.cloudinary.com/hrvt6ouf6/image/upload/v1591226036/seeds/lr_emzgau.jpg',
  }, {
    name: 'Pastoral',
    ...
    created_at: new Date(),
    updated_at: new Date(),
    img: 'https://res.cloudinary.com/hrvt6ouf6/image/upload/v1591226037/seeds/cpu_uqoopk.png',
  }], {}),
